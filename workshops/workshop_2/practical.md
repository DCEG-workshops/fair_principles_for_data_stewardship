...
If you go to your project directory, you will see that two new files were created— `README.md` and `LICENSE`. Another hidden file, `.gitignore`, is created that will keep a list of all the files to not track by Git. You can open these files in a text editor to see their contents. 
